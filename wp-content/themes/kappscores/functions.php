...
if ( ! function_exists( 'kappscores_setup' ) ) :
	...
	function kappscores_setup() {
		...
		add_image_size('kappscores-index-img', 800, 450, true);
...
function kappscores_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'kappscores' ),
...
function kappscores_scripts() {
    ...
    wp_enqueue_script( 'kappscores-functions', get_template_directory_uri() . '/js/functions.js', array('jquery'), '20190211', true );
